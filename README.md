...
<p align="center">
Java • Spring Boot • MongoDB • JWT • Microsserviços • Docker • CI/CD
</p>
...
<p>
O <strong>ms-projeto-agendador-tarefas</strong> é o microserviço responsável pelo
<strong>cadastro, gerenciamento e controle de tarefas</strong> dentro do
<strong>Projeto Agendador</strong>.
</p>

<p>
Ele centraliza as regras de negócio relacionadas às tarefas, como criação,
atualização, listagem e exclusão, além de integrar-se com outros microsserviços
do ecossistema, como o serviço de usuários e o serviço de notificações.
</p>
...
<ul>
  ...
  <li>Configuração de segurança com Spring Security</li>
</ul>
...
<ul>
  ...
  <li>Mapeamento entre DTO ↔ Entity</li>
